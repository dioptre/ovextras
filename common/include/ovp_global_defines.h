...
#define OVP_GD_Algorithm_LDAClassifier_InputParameterId_FeatureVector                                                        OpenViBE::CIdentifier(0x6d69bf98, 0x1eb9ee66)
#define OVP_GD_Algorithm_LDAClassifier_InputParameterId_Configuration                                                        OpenViBE::CIdentifier(0xa705428e, 0x5bb1cadd)
#define OVP_GD_Algorithm_LDAClassifier_OutputParameterId_Configuration                                                       OpenViBE::CIdentifier(0x30590936, 0x61ce5971)
#define OVP_GD_Algorithm_LDAClassifier_OutputParameterId_Class                                                               OpenViBE::CIdentifier(0x8a39a7ea, 0xf2ee45c4)
#define OVP_GD_Algorithm_LDAClassifier_OutputParameterId_ClassificationValues                                                OpenViBE::CIdentifier(0xda77d7e4, 0x766b48ea)
#define OVP_GD_Algorithm_LDAClassifier_InputTriggerId_Train                                                                  OpenViBE::CIdentifier(0x34684752, 0x78a46de2)
#define OVP_GD_Algorithm_LDAClassifier_InputTriggerId_SaveConfiguration                                                      OpenViBE::CIdentifier(0x79750528, 0x6cc85fc1)
#define OVP_GD_Algorithm_LDAClassifier_InputTriggerId_Classify                                                               OpenViBE::CIdentifier(0x843a87d8, 0x566e85a1)
...
#define OVP_GD_Algorithm_SVMClassifier_InputParameterId_FeatureVectorSet                                                        OpenViBE::CIdentifier(0x27c05927, 0x5de9103a) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputParameterId_FeatureVectorSet
...
#define OVP_GD_Algorithm_SVMClassifier_InputParameterId_FeatureVector                                                           OpenViBE::CIdentifier(0x6d69bf98, 0x1eb9ee66) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputParameterId_FeatureVector
#define OVP_GD_Algorithm_SVMClassifier_InputParameterId_Coef0                                                                   OpenViBE::CIdentifier(0x724d5ec5, 0x13e56658)
#define OVP_GD_Algorithm_SVMClassifier_InputParameterId_Configuration                                                           OpenViBE::CIdentifier(0xa705428e, 0x5bb1cadd) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputParameterId_Configuration
#define OVP_GD_Algorithm_SVMClassifier_OutputParameterId_Configuration                                                          OpenViBE::CIdentifier(0x30590936, 0x61ce5971) // Duplicate of OVP_GD_Algorithm_LDAClassifier_OutputParameterId_Configuration
#define OVP_GD_Algorithm_SVMClassifier_OutputParameterId_Class                                                                  OpenViBE::CIdentifier(0x8a39a7ea, 0xf2ee45c4) // Duplicate of OVP_GD_Algorithm_LDAClassifier_OutputParameterId_Class
#define OVP_GD_Algorithm_SVMClassifier_OutputParameterId_ClassificationValues                                                   OpenViBE::CIdentifier(0xda77d7e4, 0x766b48ea) // Duplicate of OVP_GD_Algorithm_LDAClassifier_OutputParameterId_ClassificationValues
#define OVP_GD_Algorithm_SVMClassifier_InputTriggerId_Train                                                                     OpenViBE::CIdentifier(0x34684752, 0x78a46de2) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputTriggerId_Train
#define OVP_GD_Algorithm_SVMClassifier_InputTriggerId_SaveConfiguration                                                         OpenViBE::CIdentifier(0x79750528, 0x6cc85fc1) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputTriggerId_SaveConfiguration
#define OVP_GD_Algorithm_SVMClassifier_InputTriggerId_Classify                                                                  OpenViBE::CIdentifier(0x843a87d8, 0x566e85a1) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputTriggerId_Classify
#define OVP_GD_Algorithm_SVMClassifier_InputTriggerId_LoadConfiguration                                                         OpenViBE::CIdentifier(0xf346bbe0, 0xadafc735) // Duplicate of OVP_GD_Algorithm_LDAClassifier_InputTriggerId_LoadConfiguration
#define OVP_GD_Algorithm_SVMClassifier_OutputTriggerId_Success                                                                  OpenViBE::CIdentifier(0x24fab755, 0x78868782) // Duplicate of OVP_GD_Algorithm_LDAClassifier_OutputTriggerId_Success
#define OVP_GD_Algorithm_SVMClassifier_OutputTriggerId_Failed                                                                   OpenViBE::CIdentifier(0x6e72b255, 0x317faa04) // Duplicate of OVP_GD_Algorithm_LDAClassifier_OutputTriggerId_Failed
