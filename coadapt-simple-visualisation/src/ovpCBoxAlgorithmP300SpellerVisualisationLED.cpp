...
boolean CBoxAlgorithmP300SpellerVisualisationLED::initialize(void)
{
	...
	m_pTarget=GTK_LABEL(gtk_builder_get_object(m_pMainWidgetInterface, "label-target"));
        ...
        //get my LED widget, set its background color
        m_pLEDWidget = GTK_WIDGET(gtk_builder_get_object(m_pMainWidgetInterface, "eventbox-led"));
        gtk_widget_modify_bg(m_pLEDWidget, GTK_STATE_NORMAL, &m_oNoFlashBackgroundColor);
	...
	this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_background_cb_, &m_oNoFlashBackgroundColor);
	this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_foreground_cb_, &m_oNoFlashForegroundColor);
	this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_font_cb_, l_pMaxFontDescription);
...
boolean CBoxAlgorithmP300SpellerVisualisationLED::uninitialize(void)
{
...
boolean CBoxAlgorithmP300SpellerVisualisationLED::processInput(uint32 ui32Index)
{
	...
	if(!m_bTableInitialized)
	{
		this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_background_cb_, &m_oNoFlashBackgroundColor);
		this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_foreground_cb_, &m_oNoFlashForegroundColor);
		this->_cache_for_each_(&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_font_cb_, m_pNoFlashFontDescription);
...
boolean CBoxAlgorithmP300SpellerVisualisationLED::process(void)
{
	// IBox& l_rStaticBoxContext=this->getStaticBoxContext();
	...
	for(i=0; i<l_rDynamicBoxContext.getInputChunkCount(0); i++)
	{
		...
		if(m_pSequenceStimulationDecoder->isOutputTriggerActive(OVP_GD_Algorithm_StimulationStreamDecoder_OutputTriggerId_ReceivedBuffer))
		{
			...
			for(j=0; j<l_pStimulationSet->getStimulationCount(); j++)
			{
				...
				if(l_bFlash)
				{
                                    //light up the LED display
                                    ::GdkColor l_MyWhite;
                                    int max = 65535;
                                    l_MyWhite.red = max;
                                    l_MyWhite.blue = max;
                                    l_MyWhite.green = max;
                                    gtk_widget_modify_bg(m_pLEDWidget, GTK_STATE_NORMAL, &l_MyWhite );

					this->_cache_for_each_if_(
						l_iRow,
						l_iColumn,
						&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_background_cb_,
						&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_background_cb_,
					...
					this->_cache_for_each_if_(
						l_iRow,
						l_iColumn,
						&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_foreground_cb_,
						&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_foreground_cb_,
					...
					this->_cache_for_each_if_(
						l_iRow,
						l_iColumn,
						&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_font_cb_,
						&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_font_cb_,
				...
				for(j=0; j<l_pStimulationSet->getStimulationCount(); j++)
				{
					...
					if(l_bTarget && m_iTargetRow!=-1 && m_iTargetColumn!=-1)
					{
						...
						this->_cache_for_each_if_(
							...
							m_iTargetColumn,
							&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_background_cb_,
							&CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_null_cb_,
						...
						this->_cache_for_each_if_(
							m_iTargetRow,
							m_iTargetColumn,
							&CBoxAlgorithmP300SpellerVisualisationLED::_cache_collect_child_widget_cb_,
							&CBoxAlgorithmP300SpellerVisualisationLED::_cache_collect_child_widget_cb_,
							&l_vWidgets,
							NULL);
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_build_from_table_(::GtkTable* pTable)
{
	if(pTable)
	{
		::GdkColor l_oWhite;
		...
		for(l_pList=pTable->children; l_pList; l_pList=l_pList->next)
		{
			...
			for(unsigned long i=l_pTableChild->top_attach; i<l_pTableChild->bottom_attach; i++)
			{
				...
				{
					CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& l_rWidgetStyle=m_vCache[i][j];
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_for_each_(_cache_callback_ fpCallback, void* pUserData)
{
	std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle > >::iterator i;
	std::map < unsigned long, CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle >::iterator j;
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_for_each_if_(int iLine, int iColumn, _cache_callback_ fpIfCallback, _cache_callback_ fpElseCallback, void* pIfUserData, void* pElseUserData)
{
	std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle > >::iterator i;
	std::map < unsigned long, CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle >::iterator j;
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_null_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData)
{
}

void CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_background_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData)
{
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_foreground_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData)
{
	::GdkColor oColor=*(::GdkColor*)pUserData;
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_change_font_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData)
{
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_collect_widget_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData)
{
	if(pUserData)
	{
...
void CBoxAlgorithmP300SpellerVisualisationLED::_cache_collect_child_widget_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData)
{
	if(pUserData)
	{
