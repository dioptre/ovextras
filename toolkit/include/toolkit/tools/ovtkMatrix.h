...
namespace OpenViBEToolkit
{
	namespace Tools
	{
		namespace Matrix
		{
			...
			OV_API OpenViBE::boolean toString(const OpenViBE::IMatrix& rMatrix, OpenViBE::CString& sString, OpenViBE::uint32 ui32Precision = 6);
			OV_API OpenViBE::boolean fromString(OpenViBE::IMatrix& rMatrix, const OpenViBE::CString& sString);

			OV_API OpenViBE::boolean saveToTextFile(const OpenViBE::IMatrix& rMatrix, const OpenViBE::CString& sFilename, OpenViBE::uint32 ui32Precision = 6);
			OV_API OpenViBE::boolean loadFromTextFile(OpenViBE::IMatrix& rMatrix, const OpenViBE::CString& sFilename);
		};
