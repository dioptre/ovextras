...
GET_PROPERTY(OV_PRINTED GLOBAL PROPERTY OV_TRIED_ThirdPartyExpat)

IF(UNIX)
	FIND_PATH(EXPAT_expat_INCLUDE_PATH "expat.h"
		PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES include)
	FIND_LIBRARY(EXPAT_expat_LIBRARY
		NAMES expat
		PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES lib)
ENDIF(UNIX)

IF(WIN32)
	FIND_PATH(EXPAT_expat_INCLUDE_PATH "expat.h"
		PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES expat/Source/lib)
	FIND_LIBRARY(EXPAT_expat_LIBRARY
		NAMES libexpat
...
IF(EXPAT_FOUND)
	OV_PRINT(OV_PRINTED "  Found expat...")
...
ELSE(EXPAT_FOUND)
	OV_PRINT(OV_PRINTED "  FAILED to find expat...")
ENDIF(EXPAT_FOUND)


SET_PROPERTY(GLOBAL PROPERTY OV_TRIED_ThirdPartyExpat "Yes")
