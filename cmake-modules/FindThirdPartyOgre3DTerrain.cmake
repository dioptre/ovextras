...
GET_PROPERTY(OV_PRINTED GLOBAL PROPERTY OV_TRIED_ThirdPartyOgre3DTerrain)

IF(OV_DISABLE_OGRE)
	OV_PRINT(OV_PRINTED "  SKIPPED Ogre3D (Terrain), disabled, no 3D ...")
	RETURN()
ENDIF(OV_DISABLE_OGRE)

IF(WIN32)
	FIND_PATH(PATH_Ogre3DTerrain include/OGRE/Ogre.h PATHS ${LIST_DEPENDENCIES_PATH} $ENV{OGRE_HOME} PATH_SUFFIXES ogre .)
...
IF(Ogre3DTerrain_FOUND AND OIS_FOUND)
	OV_PRINT(OV_PRINTED "  Found Ogre3DTerrain/OIS...")
	...
	# OV_PRINT(OV_PRINTED "A ${OIS_CFLAGS} ${Ogre3DTerrain_CFLAGS} B ${OIS_CFLAGS_OTHERS} ${Ogre3DTerrain_CFLAGS_OTHERS} C ${Ogre3DTerrain_LIBRARIES_RELEASE} D ${Ogre3DTerrain_LIBRARIES_DEBUG}")
	...
	IF(UNIX) 
		FOREACH(Ogre3DTerrain_LIB ${Ogre3DTerrain_LIBRARIES} ${OIS_LIBRARIES})
			...
			IF(Ogre3DTerrain_LIB1)
				OV_PRINT(OV_PRINTED "    [  OK  ] Third party lib ${Ogre3DTerrain_LIB1}")
				TARGET_LINK_LIBRARIES(${PROJECT_NAME} ${Ogre3DTerrain_LIB1})
			ELSE(Ogre3DTerrain_LIB1)
				OV_PRINT(OV_PRINTED "    [FAILED] Third party lib ${Ogre3DTerrain_LIB}")
...
ELSE(Ogre3DTerrain_FOUND AND OIS_FOUND)
	OV_PRINT(OV_PRINTED "  FAILED to find Ogre3DTerrain/OIS...")
ENDIF(Ogre3DTerrain_FOUND AND OIS_FOUND)



SET_PROPERTY(GLOBAL PROPERTY OV_TRIED_ThirdPartyOgre3DTerrain "Yes")
