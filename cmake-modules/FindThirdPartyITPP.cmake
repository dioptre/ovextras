...
IF(UNIX)
	...
	FIND_PATH(PATH_ITPP include/itpp/itbase.h PATHS ${OV_CUSTOM_DEPENDENCIES_PATH})
	IF(PATH_ITPP)
		SET(ITPP_FOUND TRUE)
		SET(ITPP_INCLUDE_DIRS ${PATH_ITPP}/include)
		SET(ITPP_LIBRARIES libblas.la libfftw3.la liblapack.la )#libgcc.a libg2c.a)
		#SET(ITPP_LIBRARIES blas fftw3 lapack )#libgcc.a libg2c.a)
		SET(ITPP_LIBRARIES_RELEASE itpp)
		#SET(ITPP_LIBRARIES_DEBUG itppd)	
		SET(ITPP_LIBRARY_DIRS ${PATH_ITPP}/lib )
	ENDIF(PATH_ITPP)
...
MESSAGE(${ITPP_LIBRARY_DIRS} ${ITPP_LIBDIR})
		IF(ITPP_LIB1)
