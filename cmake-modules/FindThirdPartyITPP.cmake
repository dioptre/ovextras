...
IF(ITPP_FOUND)
	...
	IF(WIN32)
		INSTALL(DIRECTORY "${PATH_ITPP}/bin/" DESTINATION "${DIST_BINDIR}" CONFIGURATIONS Debug PATTERN "*MT.dll" EXCLUDE PATTERN "*pp.dll" EXCLUDE )
		INSTALL(DIRECTORY "${PATH_ITPP}/bin/" DESTINATION "${DIST_BINDIR}" CONFIGURATIONS Release PATTERN "*d.dll" EXCLUDE )
	ENDIF()
