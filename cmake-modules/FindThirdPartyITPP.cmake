...
IF(ITPP_FOUND)
	...
	IF(WIN32)
		FILE(GLOB ITPP_DLL_DEB "${PATH_ITPP}/bin/*d.dll")
		FILE(GLOB ITPP_DLL_REL "${PATH_ITPP}/bin/*.dll")
		LIST(REMOVE_ITEM ITPP_DLL_REL ${ITPP_DLL_DEB})

		INSTALL(FILES "${ITPP_DLL_DEB}" DESTINATION "${DIST_BINDIR}" CONFIGURATIONS Debug)
		INSTALL(FILES "${ITPP_DLL_REL}" DESTINATION "${DIST_BINDIR}" CONFIGURATIONS Release)
	ENDIF()
