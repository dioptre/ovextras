...
IF(WIN32)
	FIND_PATH(PATH_ActiCHampAPI ActiChamp.h PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES sdk-brainproducts-actichamp)
	IF(PATH_ActiCHampAPI)
		...
		INSTALL(PROGRAMS "${FIRMWARE_ActiCHampAPI}" DESTINATION ${DIST_LIBDIR})
