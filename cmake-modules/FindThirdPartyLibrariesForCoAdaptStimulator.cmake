...
ELSE(PATH_GL)
	OV_PRINT(OV_PRINTED "  FAILED to find OpenGL (needed for CoAdapt P300)" )
	SET(foundIncludeDir 0)
ENDIF(PATH_GL)

#GLFW (for initializing OpenGL context, lighter than SDL)
IF(WIN32)
	FIND_PATH(PATH_GLFW include/GLFW/glfw3.h PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES GLFW .)
	IF(PATH_GLFW)
		OV_PRINT(OV_PRINTED "  Found GLFW3 in ${PATH_GLFW}" )
		INCLUDE_DIRECTORIES(${PATH_GLFW}/include)
	ELSE(PATH_GLFW)
		OV_PRINT(OV_PRINTED "  FAILED to find GLFW3 (needed for CoAdapt P300)" )
		SET(foundIncludeDir 0)
	ENDIF(PATH_GLFW)
ELSE(WIN32)
...
IF(WIN32)
	FIND_PATH(PATH_INPOUT32 include/inpout32.h PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES inpout32)
	IF(PATH_INPOUT32)
	...
	ELSE(PATH_INPOUT32)
		OV_PRINT(OV_PRINTED "  FAILED to find inpout32 (optional), CoAdapt P300 parallel port tagging support disabled")	
		# optional 
	ENDIF(PATH_INPOUT32)
ENDIF(WIN32)

FIND_PATH(PATH_PRESAGE presage.h PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES include include/presage presage/include)
IF(PATH_PRESAGE)
...
ELSE(PATH_PRESAGE)
	OV_PRINT(OV_PRINTED "  FAILED to find presage (optional), CoAdapt P300 word prediction disabled")
	# optional
ENDIF(PATH_PRESAGE)
...
IF(foundIncludeDir)
	...
	IF(WIN32)
		FIND_LIBRARY(LIB_GLFW glfw3 PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES GLFW/lib)
		IF(LIB_GLFW)
		...
		IF(PATH_PRESAGE)
			FIND_LIBRARY(LIB_presage libpresage-1 PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES presage/lib)		
			IF(LIB_presage)
		...
		#inpout32.lib
		IF(PATH_INPOUT32)
			FIND_LIBRARY(LIB_INPOUT32 NAMES "inpout32.lib" PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES inpout32/lib)
			IF(LIB_INPOUT32)
	...
	ELSE(WIN32)
		...
		FOREACH(GLFW_LIB ${GLFW_LIBRARIES})
			...
			FIND_LIBRARY(GLFW_LIB1 NAMES ${GLFW_LIB} PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES lib)
		...
		IF(PATH_PRESAGE)
			FIND_LIBRARY(LIB_PRESAGE ${name_libpresage} PATHS ${LIST_DEPENDENCIES_PATH} PATH_SUFFIXES lib)
			IF(LIB_PRESAGE)
