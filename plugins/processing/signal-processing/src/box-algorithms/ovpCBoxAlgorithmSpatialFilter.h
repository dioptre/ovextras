#ifndef __OpenViBEPlugins_BoxAlgorithm_SpatialFilterWithUpdate_H__
#define __OpenViBEPlugins_BoxAlgorithm_SpatialFilterWithUpdate_H__
...
namespace OpenViBEPlugins
{
	namespace SignalProcessingCoAdapt
	{
		...
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_SpatialFilterWithUpdate);
...
*/
		...
		public:
			...
			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("Spatial Filter With Update"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_SpatialFilterWithUpdate; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SignalProcessingCoAdapt::CBoxAlgorithmSpatialFilter; }
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_SpatialFilterWithUpdateDesc);
		};
	};
};
