...
void CBoxAlgorithmSkeletonGenerator::buttonOkCB(void)
{
	...
	CString l_sTemplate(OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/box.h-skeleton");
...
*/
	...
	if(m_bUseCodecToolkit)
	{
		l_sTemplate= OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/box.cpp-codec-toolkit-skeleton";
	}
	else
	{
		l_sTemplate= OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/box.cpp-skeleton";
	}
	if(!this->generate(l_sTemplate,l_sDest,l_mSubstitutions,l_sLogMessages))
	{
		gtk_text_buffer_set_text (l_pTextBuffer,
	...
	l_sTemplate = OpenViBE::Directories::getDataDir() + "/applications/skeleton-generator/readme-box.txt-skeleton";
