...
function initialize(box)
	...
	baseline_duration = box:get_setting(6)
	wait_for_beep_duration = box:get_setting(7)
	wait_for_cue_duration = box:get_setting(8)
	display_cue_duration = box:get_setting(9)
	feedback_duration = box:get_setting(10)
	end_of_trial_min_duration = box:get_setting(11)
	end_of_trial_max_duration = box:get_setting(12)
	...
	for i = 1, number_of_trials do
		a = math.random(1, number_of_trials*3)
		b = math.random(1, number_of_trials*3)
		c = math.random(1, number_of_trials*3)
		swap = sequence[a]
