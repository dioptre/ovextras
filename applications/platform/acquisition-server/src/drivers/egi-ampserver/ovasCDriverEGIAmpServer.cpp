	...
	IDriverCallback& rCallback)
{
	...
	this->execute(OpenViBE::Directories::getDataDir() + "/applications/acquisition-server/scripts/egi-default-initialize.script");
...
boolean CDriverEGIAmpServer::start(void)
{
	...
	this->execute(OpenViBE::Directories::getDataDir() + "/applications/acquisition-server/scripts/egi-default-start.script");
...
boolean CDriverEGIAmpServer::stop(void)
{
	...
	this->execute(OpenViBE::Directories::getDataDir() + "/applications/acquisition-server/scripts/egi-default-stop.script" );
...
boolean CDriverEGIAmpServer::uninitialize(void)
{
	...
	if(m_pCommand)
	{
		...
		this->execute(OpenViBE::Directories::getDataDir() + "/applications/acquisition-server/scripts/egi-default-uninitialize.script");
...
boolean CDriverEGIAmpServer::execute(const char* sScriptFilename)
{
