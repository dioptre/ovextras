...
{
	CConfigurationNeuroskyMindset m_oConfiguration(m_rDriverContext, OpenViBE::Directories::getDataDir() + "/applications/acquisition-server/interface-Neurosky-Mindset.ui"
		,m_ui32ComPort
		,m_bESenseChannels
