def setUp(self):
    ...
    self.terminal = App.open("xterm -e " +
            ...
            ov_binany_path +"share/openvibe/scenarios/box-tutorials/modTemporalFilter.xml")
...
def testChangeParametersOnline(self):
    ...
    dragDrop(Pattern("InitialStateSignalDisplay.png").targetOffset(-211,-167), Pattern("InitialStateSignalDisplay.png").targetOffset(159,-172))
