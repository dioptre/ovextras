	...
	namespace FileReadingAndWriting
	{
		...
		*/
		...
		public:
			...
			virtual OpenViBE::CString getDetailedDescription(void) const { return OpenViBE::CString("write something to shared memory so that it can be read by another process"); }
