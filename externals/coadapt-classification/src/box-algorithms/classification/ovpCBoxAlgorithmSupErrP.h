#ifndef __OpenViBEPlugins_BoxAlgorithm_SupErrP_H__
#define __OpenViBEPlugins_BoxAlgorithm_SupErrP_H__
...
namespace OpenViBEPlugins
{
	...
	{
		/**
		 * \class CBoxAlgorithmSupErrP
		 * \author Loïc MAHE (ECM)
		 * \date Tue Apr 24 18:16:16 2012
		 * \brief The class CBoxAlgorithmSupErrP describes the box SupErrP.
		 *
		 */
		class CBoxAlgorithmSupErrP : virtual public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_SupErrP);
		...
		protected:
			...
			//boolean to help determine when the reward should be calculed
		...
		*/
		...
		class CBoxAlgorithmSupErrPListener : public OpenViBEToolkit::TBoxListener < OpenViBE::Plugins::IBoxListener >
		{
		public:
		...
		*/
		...
		/**
		 * \class CBoxAlgorithmSupErrPDesc
		 * \author Loïc MAHE (ECM)
		 * \date Tue Apr 24 18:16:16 2012
		 * \brief Descriptor of the box SupErrP.
		 *
		 */
		class CBoxAlgorithmSupErrPDesc : virtual public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("SupErrP"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_SupErrP; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::Classification::CBoxAlgorithmSupErrP; }
			
			/*
			virtual OpenViBE::Plugins::IBoxListener* createBoxListener(void) const               { return new CBoxAlgorithmSupErrPListener; }
			...
			*/
				...
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				...
				rBoxAlgorithmPrototype.addOutput("Reward",OV_TypeId_Stimulations);
...
//rBoxAlgorithmPrototype.addSetting("Setting Name",OV_TypeId_XXXX,"default value");
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_SupErrPDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_SupErrP_H__
