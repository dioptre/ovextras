#ifndef __OpenViBEPlugins_BoxAlgorithm_P300SpellerVisualisationLED_H__
#define __OpenViBEPlugins_BoxAlgorithm_P300SpellerVisualisationLED_H__
...
#define OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationLED		OpenViBE::CIdentifier(0x6098D226, 0x07A9770E)
#define OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationLEDDesc         OpenViBE::CIdentifier(0x76F927B4, 0x0182F1DC)

namespace OpenViBEPlugins
{
	namespace SimpleVisualisation
	{
		class CBoxAlgorithmP300SpellerVisualisationLED : public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >
		{
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationLED);
		...
		private:
			...
			typedef void (CBoxAlgorithmP300SpellerVisualisationLED::*_cache_callback_)(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
			...
			void _cache_change_null_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_background_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_foreground_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_font_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_collect_widget_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_collect_child_widget_cb_(CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle& rWidgetStyle, void* pUserData);
		...
		private:
			...
			std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualisationLED::SWidgetStyle > > m_vCache;
			std::list < std::pair < int, int > > m_vTargetHistory;
		};

		class CBoxAlgorithmP300SpellerVisualisationLEDDesc : public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("P300 Speller Visualisation LED"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationLED; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SimpleVisualisation::CBoxAlgorithmP300SpellerVisualisationLED; }
			...
			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationLEDDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_P300SpellerVisualisationLED_H__
