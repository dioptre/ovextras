#ifndef __OpenViBEPlugins_BoxAlgorithm_P300SpellerVisualisationSplotch_H__
#define __OpenViBEPlugins_BoxAlgorithm_P300SpellerVisualisationSplotch_H__
...
typedef std::list<std::pair<unsigned long,unsigned long> > FlashGroupType;
typedef std::map<unsigned long,  FlashGroupType> FlashDictionaryType;

namespace OpenViBEPlugins
{
	namespace SimpleVisualisation
	{
		class CBoxAlgorithmP300SpellerVisualisationSplotch : public OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, public XML::IReaderCallback
		{
		...
		public:
			...
			_IsDerivedFromClass_Final_(OpenViBEToolkit::TBoxAlgorithm < OpenViBE::Plugins::IBoxAlgorithm >, OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationSplotch);

		private:

			FlashDictionaryType flashGroups;
			...
			typedef void (CBoxAlgorithmP300SpellerVisualisationSplotch::*_cache_callback_)(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			...
			void _cache_change_null_cb_(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_background_cb_(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_foreground_cb_(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_change_font_cb_(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_collect_widget_cb_(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			void _cache_collect_child_widget_cb_(CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle& rWidgetStyle, void* pUserData);
			bool isMemberOfGroup(bool rowGroup, unsigned long row_col_id, unsigned long row, unsigned long col);
			void initializeFlashGroupDictionary(OpenViBE::CString filename);
		...
		protected:
			...
			::GdkColor m_oWronglySelectedBackgroundColor;
			::GdkColor m_oWronglySelectedForegroundColor;
			OpenViBE::uint64 m_ui64WronglySelectedFontSize;
			::PangoFontDescription* m_pWronglySelectedFontDescription;
		...
		private:
			...
			std::map < unsigned long, std::map < unsigned long, CBoxAlgorithmP300SpellerVisualisationSplotch::SWidgetStyle > > m_vCache;
			std::list < std::pair < int, int > > m_vTargetHistory;
		};

		class CBoxAlgorithmP300SpellerVisualisationSplotchDesc : public OpenViBE::Plugins::IBoxAlgorithmDesc
		{
		public:

			virtual void release(void) { }

			virtual OpenViBE::CString getName(void) const                { return OpenViBE::CString("P300 Speller Visualisation Splotch"); }
			...
			virtual OpenViBE::CIdentifier getCreatedClass(void) const    { return OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationSplotch; }
			virtual OpenViBE::Plugins::IPluginObject* create(void)       { return new OpenViBEPlugins::SimpleVisualisation::CBoxAlgorithmP300SpellerVisualisationSplotch; }
				...
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				...
				rBoxAlgorithmPrototype.addSetting("Wrongly selected background color",       OV_TypeId_Color,       "70,20,20");
				rBoxAlgorithmPrototype.addSetting("Wrongly selected foreground color",       OV_TypeId_Color,       "30,10,10");
				rBoxAlgorithmPrototype.addSetting("Wrongly selected font size",              OV_TypeId_Integer,     "100");

				rBoxAlgorithmPrototype.addSetting("Result font size",              OV_TypeId_Integer,     "20");

				rBoxAlgorithmPrototype.addSetting("Letters group filename",              OV_TypeId_Filename,    "");

				return true;
			}

			_IsDerivedFromClass_Final_(OpenViBE::Plugins::IBoxAlgorithmDesc, OVP_ClassId_BoxAlgorithm_P300SpellerVisualisationSplotchDesc);
		};
	};
};

#endif // __OpenViBEPlugins_BoxAlgorithm_P300SpellerVisualisationSplotch_H__
