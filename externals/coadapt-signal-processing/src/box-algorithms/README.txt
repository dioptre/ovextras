...
[Mon Nov 12 10:06:07 2012]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmLikelinessDistributor.h
- ovpCBoxAlgorithmLikelinessDistributor.cpp
...
You may have to change the file ovpCBoxAlgorithmLikelinessDistributor.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmLikelinessDistributor.h"
