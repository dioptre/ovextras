	...
	namespace Kernel
	{
        ...
        public:
            // Returned references are invalid after processMessage().
                virtual OpenViBE::uint64 getValueUint64(OpenViBE::CString &key, bool &success) const=0;
                virtual OpenViBE::float64 getValueFloat64(CString &key, bool &success) const=0;
                virtual const OpenViBE::CString* getValueCString(CString &key, bool &success) const=0;
                virtual const OpenViBE::IMatrix* getValueCMatrix(CString &key, bool &success) const=0;
