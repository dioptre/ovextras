...
{
	CConfigurationBrainmasterDiscovery m_oConfiguration(OpenViBE::Directories::getDataDir() + "/applications/acquisition-server/interface-Brainmaster-Discovery.ui", 
		m_ui32Port, m_ui32Preset, m_ui32Type, m_ui32BaudRate, m_ui32SamplingRate, m_ui32BitDepth, m_ui32NotchFilters, m_vChannelType, m_sDeviceSerial, m_sDevicePasskey);
