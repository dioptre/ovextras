	...
	namespace Stimulation
	{
		...
		public:
			...
			virtual OpenViBE::boolean onSettingAdded(OpenViBE::Kernel::IBox& rBox, const OpenViBE::uint32 ui32Index)
			{
				...
				rBox.setSettingDefaultValue(ui32Index+1, "${Path_Data}/plugins/stimulation/ov_beep.wav");
				rBox.setSettingValue(ui32Index+1, "${Path_Data}/plugins/stimulation/ov_beep.wav");
		...
		public:
				...
				OpenViBE::Kernel::IBoxProto& rBoxAlgorithmPrototype) const
			{
				...
				rBoxAlgorithmPrototype.addSetting("Sound to play", OV_TypeId_Filename, "${Path_Data}/plugins/stimulation/ov_beep.wav");
