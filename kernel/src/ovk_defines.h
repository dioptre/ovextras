...
#define OVK_ClassId_Kernel_Player_MyMessage                OpenViBE::CIdentifier(0x036401EF, 0x31A90C38)
...
#define OVK_ClassId_Kernel_Scenario_MessageLink                      OpenViBE::CIdentifier(0x117EF337, 0x095F5A5E)
