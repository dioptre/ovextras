	...
	namespace Kernel
	{
		namespace
		{
			...
			public:
				...
				virtual __BridgeImplFunc4__((*m_pBox), boolean, addSetting, , return false, const CString&, sName, const CIdentifier&, rTypeIdentifier, const CString&, sDefaultValue, int32, i32Index);
