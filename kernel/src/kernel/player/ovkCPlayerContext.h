...
namespace OpenViBE
{
	namespace Kernel
	{
		...
		public:
            ...
            virtual OpenViBE::boolean sendMessage( OpenViBE::Kernel::IMyMessage& message, OpenViBE::uint32 outputIndex);
            virtual OpenViBE::Kernel::IMyMessage& createMessage(void);
